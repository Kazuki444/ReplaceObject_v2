 ...
 * Changes
 *
 * - Argument name (SampleRender -> MyRender)
 */
...
public class MyRender {
   ...
   */
  public MyRender(GLSurfaceView glSurfaceView, Renderer renderer, AssetManager assetManager) {
    ...
    glSurfaceView.setRenderer(
            new GLSurfaceView.Renderer() {
              ...
              public void onSurfaceCreated(GL10 gl, EGLConfig config) {
                ...
                renderer.onSurfaceCreated(MyRender.this);
              }
              ...
              public void onSurfaceChanged(GL10 gl, int w, int h) {
                viewportWidth = w;
                viewportHeight = h;
                renderer.onSurfaceChanged(MyRender.this, w, h);
              }

              @Override
              public void onDrawFrame(GL10 gl) {
                clear(/*framebuffer=*/ null, 0f, 0f, 0f, 1f);
                renderer.onDrawFrame(MyRender.this);
              }
            });
  ...
  public static interface Renderer {
    /**
     * Called by {@link MyRender} when the GL render surface is created.
     *
    ...
    /**
     * Called by {@link MyRender} when the GL render surface dimensions are changed.
     *
    ...
    /**
     * Called by {@link MyRender} when a GL frame is to be rendered.
     *

...
public class Texture implements Closeable {
   ...
   */
  public Texture(MyRender render, Target target, WrapMode wrapMode) {
    this(render, target, wrapMode, /*useMipmaps=*/ true);
  }

  public Texture(MyRender render, Target target, WrapMode wrapMode, boolean useMipmaps) {
    this.target = target;
  ...
  public static Texture createFromAsset(
          MyRender render, String assetFileName, WrapMode wrapMode, ColorFormat colorFormat)
          throws IOException {

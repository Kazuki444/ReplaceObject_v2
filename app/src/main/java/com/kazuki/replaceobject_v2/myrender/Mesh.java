 ...
 *
 * <p>To render the mesh, use {@link MyRender#draw()}.
 */
public class Mesh implements Closeable {
   ...
   * (location 2, vec3).
   */
  public static Mesh createFromAsset(MyRender render, String assetFileName) throws IOException {
